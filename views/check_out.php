...
<input id="js-returnToShoppingCartButton" class="submitBtn" type="submit" name="returnToShoppingCart" value="Return to Shopping Cart" formaction="./index.php?action=view_cart">
